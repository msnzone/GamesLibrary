window.zs = window.zs || {}, window.zs.laya = window.zs.laya || {}, function(e, t) {
    ...
    class s extends t.Script {
        ...
        static showScreenAd(e) {
            ...
            })), YYGGames.audio.play(this.openSound)) : console.error("showScreenAd error"));
        }
        static hideScreenAd() {
        ...
        static showListAd(e) {
            ...
            })), YYGGames.audio.play(this.openSound)) : console.error("showListAd error"));
        }
        static hideListAd() {
        ...
        static showHomeFloatAd(e) {
            ...
            })), YYGGames.audio.play(this.openSound)) : console.error("showHomeFloatAd error"));
        }
    ...
    class u extends t.Script {
        ...
        onClick() {
            YYGGames.audio.play(s.soundClick), this.owner.mouseEnabled = !1, s.showListAd(), 
    ...
    class p extends t.Script {
        ...
        onClick() {
            YYGGames.audio.play(s.soundClick), this.owner.mouseEnabled = !1, s.showHomeFloatAd(), 
            this.owner.mouseEnabled = !0;
        }
    }
    ...
    class m extends t.Script {
        ...
        onClick() {
            YYGGames.audio.play(s.soundClick), this.owner.mouseEnabled = !1, s.showScreenAd(), 
            this.owner.mouseEnabled = !0;
        }
    }
    ...
    class g extends t.Script {
        ...
        onClick() {
            console.log("openInvite"), YYGGames.audio.play(s.soundClick), zs.laya.sdk.SdkService.openShare(zs.laya.platform.ADConfig.zs_share_title, zs.laya.platform.ADConfig.zs_share_image);
        }
    }
    ...
    class v extends zs.laya.base.ZhiSeView {
        ...
        closeView() {
            YYGGames.audio.play(s.soundClick), s.currentView = "", this.owner.close();
        }
    }
    ...
    class E extends zs.laya.base.ZhiSeView {
        ...
        onOpenListAd() {
            // YYGGames.audio.play(s.soundClick), s.showListAd();
        }
    }
