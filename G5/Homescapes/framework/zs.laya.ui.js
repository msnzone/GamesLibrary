window.zs = window.zs || {}, window.zs.laya = window.zs.laya || {}, function(e, t) {
    ...
    class a extends t.Script {
        ...
        onClick() {
            platform.getInstance().showInterstitial(()=>{
                ...
                YYGGames.audio.play(e.appConfig.soundClick), 
    ...
    class o extends t.Script {
        ...
        onClick() {
            YYGGames.audio.play(zs.laya.game.AppMain.appConfig.soundClick), zs.laya.game.UIService.showStore();
        }
    }
    ...
    class n extends t.Script {
        ...
        onClick() {
            // YYGGames.audio.play(zs.laya.game.AppMain.appConfig.soundClick), this.owner.mouseEnabled = !1, 
            ...
            // }, [ Date.now() ]), zs.laya.sdk.SdkService.openShare(zs.laya.platform.ADConfig.zs_share_title, zs.laya.platform.ADConfig.zs_share_image)) : 2 == this.statusClip.index ? this.relive() : 
    ...
    class p extends zs.laya.base.ZhiSeView {
        ...
        onClickConfirm() {
            ...
            YYGGames.audio.play(zs.laya.game.AppMain.appConfig.soundClick);
        }
    }
