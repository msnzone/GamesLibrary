window.zs = window.zs || {}, window.zs.laya = window.zs.laya || {}, function(e, s) {
    ...
    class o extends s.Script {
        ...
        static showRelive(e) {
            ...
            })), YYGGames.audio.play(this.openSound)) : console.error("showRelive error");
        }
        static hideRelive() {
        ...
        static showScore(e) {
            ...
            })), YYGGames.audio.play(this.openSound)) : console.error("showScore error");
        }
        static hideScore() {
        ...
        static showStore(e) {
            ...
            })), YYGGames.audio.play(this.openSound)) : console.error("showStore error");
        }
        static hideStore() {
        ...
        static showTreasure(e) {
            ...
            })), YYGGames.audio.play(this.openSound)) : console.error("treasure error");
        }
        static hideTreasure() {
