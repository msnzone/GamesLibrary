...
TD.init = function(stage, callback) {
    TD.stage = stage;
    DataCache.load("data/game/worlds.json", function(data) {
...
Hint.show = function(id, obj, arrowPos) {
    ...
    DataCache.load("data/game/tooltip.json", function(data) {
...
var I18 = {
    ...
    init: function(locale, callback) {
        ...
        Utils.get("language/" + locale + ".json?v=" + (new Date).getTime(), null, "json", function(data) {
            var strings = {};
            var parts = data.s;
