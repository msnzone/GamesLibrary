(function() {
    ...
    function(e) {
        ...
        },
        {
            singleton: null,
            getInstance: function() {
                return n.singleton = n.singleton || new n,
                n.singleton
            }
        });
        return n
    ...
    function(e, t) {
        var n, r, i, s, o, u, a, f = e.Model.extend({
            ...
            requestAds: function(e) {
                i.initialize();
                var t = this;
                r = new google.ima.AdsLoader(i),
                r.addEventListener(google.ima.AdsManagerLoadedEvent.Type.ADS_MANAGER_LOADED,
                function(e) {
                    t.onAdsManagerLoaded(e)
                },
                !1),
                r.addEventListener(google.ima.AdErrorEvent.Type.AD_ERROR,
                function(e) {
                    t.onAdError(e)
                },
                !1);
                var n = new google.ima.AdsRequest;
                n.adTagUrl = "http://googleads.g.doubleclick.net/pagead/ads?ad_type=image&client=" + this.get("ad_client") + "&channel=" + e,
                console.log(n.adTagUrl),
                n.linearAdSlotWidth = 300,
                n.linearAdSlotHeight = 250,
                n.nonLinearAdSlotWidth = 300,
                n.nonLinearAdSlotHeight = 250,
                r.requestAds(n)
            },
            onAdsManagerLoaded: function(e) {
                ...
                n = e.getAdsManager(u);
                var r = this;
                n.addEventListener(google.ima.AdErrorEvent.Type.AD_ERROR, this.onAdError),
                n.addEventListener(google.ima.AdEvent.Type.CONTENT_PAUSE_REQUESTED, this.onContentPauseRequested),
                n.addEventListener(google.ima.AdEvent.Type.CONTENT_RESUME_REQUESTED, this.onContentResumeRequested),
                n.addEventListener(google.ima.AdEvent.Type.ALL_ADS_COMPLETED, this.onAdEvent),
                ...
                try {
                    n.init(300, 250, google.ima.ViewMode.NORMAL),
                    n.start()
                } catch(i) {
                    console.log(i)
                }
                ...
                case google.ima.AdEvent.Type.STARTED:
                    ...
                    try {
                        ...
                        s = setInterval(function() {
                            r = i--,
                            t("#timerText").html("Advertisement will close automatically in: " + r),
                            r === 0 && (clearInterval(s), t.magnificPopup.close())
                        },
                        1e3)
                    } catch(o) {
                        console.log(o)
        ...
        },
        {
            singleton: null,
            getInstance: function() {
                return f.singleton = f.singleton || new f,
                f.singleton
            }
        });
        return f
