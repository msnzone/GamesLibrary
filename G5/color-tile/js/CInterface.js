function CInterface() {
    ...
    this.initBestScoreText = function(){
        ...
        _oBestScoreText = new createjs.Text(TEXT_BEST_SCORE + " " + s_iBestScore, "32px " + PRIMARY_FONT, PRIMARY_FONT_COLOUR);
        _oBestScoreText.textAlign = "center";
        _oBestScoreText.textBaseline = "alphabetic";
	_oBestScoreContainer.addChild(_oBestScoreText);
        
        _oBestScoreContainer.x = CANVAS_WIDTH_HALF;
        _oBestScoreContainer.y = CANVAS_HEIGHT - 250;
