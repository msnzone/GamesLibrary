function CMain(oData) {
    ...
    this._initSounds = function () {
        ...
        aSoundsInfo.push({path: './sounds/',filename:'change_colour',loop:false,volume:1, ingamename: 'change_colour'});
        aSoundsInfo.push({path: './sounds/',filename:'destroy_row',loop:false,volume:1, ingamename: 'destroy_row'});
