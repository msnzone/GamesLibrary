...
fg_api.prototype.adsModule = function() {
	...
	module.prototype.getAdTagUrl = function(variant) {
		...
		myadTagUrl = "https://securepubads.g.doubleclick.net/gampad/ads?npa=1&impl=s&gdfp_req=1&env=vp&output=xml_vast4&overlay=0&unviewed_position_start=1&url=[referrer_url]&correlator=[timestamp]&ciu_szs=";
	...
	module.prototype.init = function() {
		...
		if (!self.hasFeature("standalone")) {
			...
			faZepto.getScript(uri, function() {
				if (typeof html5games_api !== "undefined" && !self.debug) {
